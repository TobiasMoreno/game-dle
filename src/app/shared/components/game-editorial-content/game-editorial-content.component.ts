...
const CONTENT: Record<string, GameEditorialContent> = {
  ...
  banderadle: {
    ...
    intro: 'BanderaDLE propone reconocer uno de 195 países a partir de su bandera desenfocada. Las rondas son ilimitadas y cada respuesta incorrecta reduce el desenfoque hasta dejar una última oportunidad con casi toda la imagen visible.',
    rules: ['Observá la bandera desenfocada y elegí un país del buscador.', 'Cada error o intento pasado consume una oportunidad y vuelve la imagen más nítida.', 'Acertá antes del sexto intento; al terminar se revela la bandera completa y el país correcto.'],
    ...
    feedback: 'El desenfoque comienza en 28 píxeles y desciende a 22, 17, 12, 7 y 2,8 píxeles. La sexta oportunidad conserva aproximadamente el diez por ciento del desenfoque inicial. Un acierto, el sexto error o el sexto intento pasado eliminan el filtro por completo. Las banderas de diseños simples pueden seguir siendo reconocibles desde el comienzo; esa diferencia forma parte de la dificultad natural del catálogo.',
    ...
    faqs: [{ question: '¿Puedo seguir jugando después de una ronda?', answer: 'Sí. BanderaDLE no tiene límite diario y el botón Nueva bandera inicia otra ronda inmediatamente.' }, { question: '¿Por qué algunas banderas siguen siendo fáciles con blur?', answer: 'El desenfoque oculta detalles y escudos, pero conserva grandes bloques de color. Los diseños simples ofrecen menos información que ocultar.' }, { question: '¿Se incluyen territorios dependientes?', answer: 'No. El conjunto actual utiliza 195 estados y no incorpora territorios dependientes.' }],
